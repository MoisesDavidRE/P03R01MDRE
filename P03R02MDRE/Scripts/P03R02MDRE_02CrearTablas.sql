...
BEGIN
    CREATE TABLE [dbo].[Choferes](
        [IdChofer] [int] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
BEGIN
    CREATE TABLE [dbo].[Rutas](
        ...
        [FechaRegistro] [datetime] NULL,
        CONSTRAINT FK_Rutas_IdChofer FOREIGN KEY (IdChofer) REFERENCES Choferes (IdChofer),
        CONSTRAINT FK_Rutas_IdCamion FOREIGN KEY (IdCamion) REFERENCES Camiones (IdCamion)
    )
END
ELSE
